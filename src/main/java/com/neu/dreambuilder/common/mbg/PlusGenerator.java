package com.neu.dreambuilder.common.mbg;
...
public class PlusGenerator {
    public static void main(String[] args) {
        FastAutoGenerator.create(
                        "jdbc:mysql://192.168.200.100:3306/dream_builder?useUnicode=true&characterEncoding=utf-8&serverTimezone=Asia/Shanghai",
                        "root", "Root_123")
